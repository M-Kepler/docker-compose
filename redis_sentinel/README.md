...
- **故障迁移后，配置被修改为：**
  ...
  sentinel myid ea5bd2e37f62a0834e1af0c27cfe15baf5d9b3c1
  sentinel config-epoch mymaster 3
  sentinel leader-epoch mymaster 3
  sentinel current-epoch 3

  sentinel known-replica mymaster 172.126.0.1 6379

  sentinel known-replica mymaster 172.126.0.3 6379

  sentinel known-sentinel mymaster 172.126.0.6 26379 2cd204746a7043140ce30cd21812ab158e601ac4

  sentinel known-sentinel mymaster 172.126.0.5 26379 a66e90d3b905f2acd643e7e4a85979e2b8bc8314
  ```
